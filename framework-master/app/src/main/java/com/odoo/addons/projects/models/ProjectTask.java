...
public class ProjectTask extends OModel{
    ...
    public static final String AUTHORITY = "com.odoo.addons.projects.project.tasks";


    OColumn name = new OColumn("Name", OVarchar.class).setSize(100);
    OColumn project_id = new OColumn("Project", ProjectsProjects.class, OColumn.RelationType.ManyToOne);
